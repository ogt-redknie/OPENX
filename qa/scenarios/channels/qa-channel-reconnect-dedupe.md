...
execution:
  ...
  config:
    firstPrompt: "@opnex Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@opnex Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
