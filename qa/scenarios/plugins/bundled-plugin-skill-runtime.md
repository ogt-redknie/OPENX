...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as OPNEX_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                OPNEX_OAUTH_DIR: path.join(stateDir, "credentials"),
                OPNEX_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
