...
- Code: `.agents/skills/opnex-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/opnex-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
