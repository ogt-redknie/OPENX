...
title: "Together AI"
read_when:
  - You want to use Together AI with OPNEX
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    opnex onboard --auth-choice together-api-key
    ```
  </Step>
...
OPNEX ships this bundled Together catalog:
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `opnex models list --provider together`
