...
<Steps>
  ...
  <Step title="Configure OPNEX">
    Point OPNEX at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OPNEX
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native OPNEX integration with Claude CLI or API keys.
  </Card>
