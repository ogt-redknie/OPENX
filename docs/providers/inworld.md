---
summary: "Inworld streaming text-to-speech for OPNEX replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In OPNEX it
...
OPNEX posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. OPNEX synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    OPNEX asks Inworld for `OGG_OPUS` so the audio plays as a native
