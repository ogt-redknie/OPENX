...
The plugin SDK is exposed as a set of narrow subpaths under `opnex/plugin-sdk/`.
...
| `plugin-sdk/config-schema`                | `OPNEXSchema`                                                                                                                                                             |
...
| `plugin-sdk/plugin-test-api`              | Minimal `OPNEXPluginApi` mock builder for direct plugin registration unit tests                                                                                           |
...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/config-schema` | Root `opnex.json` Zod schema export (`OPNEXSchema`) |
    ...
    | `plugin-sdk/bundled-channel-config-schema` | Bundled OPNEX channel config schemas for maintained bundled plugins only |
  ...
  <Accordion title="Runtime and storage subpaths">
    ...
    | `plugin-sdk/config-types` | Type-only config surface for plugin config shapes such as `OPNEXConfig` and channel/provider config types |
    ...
    | `plugin-sdk/agent-harness` | Experimental trusted-plugin surface for low-level agent harnesses: harness types, active-run steer/abort helpers, OPNEX tool bridge helpers, runtime-plan tool policy helpers, terminal outcome classification, tool progress formatting/detail helpers, and attempt result utilities |
