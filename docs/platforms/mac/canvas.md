...
- `opnex-canvas://main/` → `<canvasRoot>/main/index.html`
- `opnex-canvas://main/assets/app.css` → `<canvasRoot>/main/assets/app.css`
- `opnex-canvas://main/widgets/todo/` → `<canvasRoot>/main/widgets/todo/index.html`
