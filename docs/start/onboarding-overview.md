---
summary: "Overview of OPNEX onboarding options and flows"
read_when:
...
OPNEX has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `opnex onboard`                     | Launch the app            |
...
CLI command docs: [`opnex onboard`](/cli/onboard)

## macOS app onboarding

Open the OPNEX app. The first-run wizard walks you through the same steps
