---
summary: "First-run setup flow for OPNEX (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OPNEX">
...
<Step title="CLI">
  ...
  The app can install the global `opnex` CLI via npm, pnpm, or bun.
