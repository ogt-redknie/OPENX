---
summary: "Contributor guide for adding a new shared capability to the OPNEX plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for OPNEX core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when OPNEX needs a new domain such as image generation, video
