...
read_when:
  - Planning a broad OPNEX application modernization pass
...
modernization task. If adopting this guidance as a repo-local OPNEX skill,
create `.agents/skills/opnex-frontend/SKILL.md` first, keep the frontmatter
