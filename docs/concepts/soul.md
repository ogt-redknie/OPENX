---
summary: "Use SOUL.md to give your OPNEX agent an actual voice instead of generic assistant sludge"
read_when:
...
OPNEX injects it on normal sessions, so it has real weight. If your agent
...
For OPNEX, `SOUL.md` is that layer.
...
Path fixed for OPNEX workspaces: use `SOUL.md`, not `http://SOUL.md`.
