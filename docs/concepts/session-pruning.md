...
OPNEX also builds a separate idempotent replay view for sessions that
...
OPNEX auto-enables pruning for Anthropic profiles:
...
If you set explicit values, OPNEX does not override them.
