...
OPNEX treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.opnex/settings/voicewake.json`

Shape:

```json
{ "triggers": ["opnex", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
