...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.opnex.ios", category: "LiveActivity")
    private var currentActivity: Activity<OPNEXActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = OPNEXActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<OPNEXActivityAttributes>.activities
    ...
    private func updateCurrent(state: OPNEXActivityAttributes.ContentState) {
    ...
    private func connectingState() -> OPNEXActivityAttributes.ContentState {
        OPNEXActivityAttributes.ContentState(
    ...
    private func idleState() -> OPNEXActivityAttributes.ContentState {
        OPNEXActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> OPNEXActivityAttributes.ContentState {
        OPNEXActivityAttributes.ContentState(
