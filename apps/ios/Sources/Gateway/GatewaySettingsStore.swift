...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.opnex.gateway"
    private static let nodeService = "ai.opnex.node"
    private static let talkService = "ai.opnex.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.opnex.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.opnex.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("opnex-gateway.log")
    }
