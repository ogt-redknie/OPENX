...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: OPNEXProtocol.AnyCodable]?
    {
        ...
        return [
            "id": OPNEXProtocol.AnyCodable(identity.deviceId),
            "publicKey": OPNEXProtocol.AnyCodable(publicKey),
            "signature": OPNEXProtocol.AnyCodable(signature),
            "signedAt": OPNEXProtocol.AnyCodable(signedAtMs),
            "nonce": OPNEXProtocol.AnyCodable(nonce),
        ]
    }
}
