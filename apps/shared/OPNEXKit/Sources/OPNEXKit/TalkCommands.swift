...
public enum OPNEXTalkCommand: String, Codable, Sendable {
...
public struct OPNEXTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OPNEXTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
