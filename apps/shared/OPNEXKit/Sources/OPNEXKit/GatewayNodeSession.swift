...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.opnex", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.opnex", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OPNEXProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
