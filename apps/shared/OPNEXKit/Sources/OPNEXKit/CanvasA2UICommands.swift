...
public enum OPNEXCanvasA2UICommand: String, Codable, Sendable {
...
public struct OPNEXCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OPNEXCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
