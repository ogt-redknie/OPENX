...
public typealias OPNEXPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OPNEXPlatformImage = UIImage
#endif

public struct OPNEXChatUsageCost: Codable, Hashable, Sendable {
...
public struct OPNEXChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OPNEXChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OPNEXChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OPNEXChatMessageContent: Codable, Hashable, Sendable {
...
public struct OPNEXChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OPNEXChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OPNEXChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OPNEXChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OPNEXChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OPNEXChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OPNEXChatMessageContent].self, forKey: .content) {
...
public struct OPNEXChatHistoryPayload: Codable, Sendable {
...
public struct OPNEXSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OPNEXSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OPNEXSessionPreviewItem]
}

public struct OPNEXSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OPNEXSessionPreviewEntry]

    public init(ts: Int, previews: [OPNEXSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OPNEXChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OPNEXChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OPNEXAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OPNEXChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct OPNEXGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OPNEXPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OPNEXPlatformImage?
...
public struct OPNEXChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
