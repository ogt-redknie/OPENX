...
public struct OPNEXChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct OPNEXChatSessionsDefaults: Codable, Sendable {
...
public struct OPNEXChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct OPNEXChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: OPNEXChatSessionsDefaults?
    public let sessions: [OPNEXChatSessionEntry]
    ...
    public init(
        ...
        sessions: [OPNEXChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
