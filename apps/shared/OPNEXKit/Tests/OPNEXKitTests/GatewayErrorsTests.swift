...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "opnex devices approve req-123",
            docsURLString: "https://docs.opnex.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "opnex devices approve req-123")
        #expect(error.docsURLString == "https://docs.opnex.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "opnex devices approve req-123")
    }
