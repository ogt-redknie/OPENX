...
import ai.opnex.app.gateway.GatewayClientInfo
import ai.opnex.app.gateway.GatewayConnectOptions
import ai.opnex.app.gateway.GatewayEndpoint
import ai.opnex.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "OPNEXAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "opnex-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "opnex-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
