...
import ai.opnex.app.ui.mobileAccentBorderStrong
...
import ai.opnex.app.ui.mobileHeadline
import ai.opnex.app.ui.mobileSurface
import ai.opnex.app.ui.mobileText
import ai.opnex.app.ui.mobileTextSecondary
import ai.opnex.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.opnex.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.opnex.app.ui.mobileFontFamily,
