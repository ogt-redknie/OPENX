...
import ai.opnex.app.VoiceCaptureMode
import ai.opnex.app.voice.VoiceConversationEntry
import ai.opnex.app.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("OPNEX is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
