...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.opnex", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OPNEX/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__opnex__/a2ui/").absoluteString + "?platform=macos"
    }
