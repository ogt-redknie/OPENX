...
/// Menu contents for the OPNEX menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About OPNEX") { self.open(tab: .about) }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .opnexSelectSettingsTab, object: tab)
        }
    }
