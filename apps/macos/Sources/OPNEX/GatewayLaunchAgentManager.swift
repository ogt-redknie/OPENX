...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.opnex", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".opnex/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.opnexCommand(
            subcommand: "gateway",
