...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .opnexSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OPNEXPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OPNEXPaths.stateDirURL.path
...
extension Notification.Name {
    static let opnexSelectSettingsTab = Notification.Name("opnexSelectSettingsTab")
}
