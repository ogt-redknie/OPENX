...
enum UIStrings {
    static let welcomeTitle = "Welcome to OPNEX"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "opnex.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: OPNEXChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g opnex@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OPNEXChatViewModel(
