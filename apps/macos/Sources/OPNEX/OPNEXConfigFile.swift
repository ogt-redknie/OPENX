...
enum OPNEXConfigFile {
    private static let logger = Logger(subsystem: "ai.opnex", category: "config")
    ...
    static func url() -> URL {
        OPNEXPaths.configURL
    }

    static func stateDirURL() -> URL {
        OPNEXPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OPNEXPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-opnex-config-file",
            "event": "config.write",
