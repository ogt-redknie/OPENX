...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/opnex/opnex") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/opnex/opnex")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://opnex.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OPNEXBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OPNEXBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OPNEXGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OPNEXGitCommit") as? String) ??
            "unknown"
    }
