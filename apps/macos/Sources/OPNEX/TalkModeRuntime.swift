...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.opnex", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.opnex", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OPNEXChatMessage] = messages.compactMap { item in
