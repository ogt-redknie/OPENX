...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.opnex", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OPNEX windows, but below the system’s pop-up menus.
