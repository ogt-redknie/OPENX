...
const WORKFLOW_PATH = ".github/workflows/opnex-cross-os-release-checks-reusable.yml";
const HARNESS = "bash workflow/scripts/github/run-opnex-cross-os-release-checks.sh";
