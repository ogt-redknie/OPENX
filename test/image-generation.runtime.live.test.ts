...
import { loadConfig, type OPNEXConfig } from "../src/config/config.js";
import {
...
const providerFilter = parseCsvFilter(process.env.OPNEX_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.OPNEX_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.OPNEX_LIVE_IMAGE_GENERATION_MODELS);
