---
name: opnex-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve OPNEX GitHub Secret Scanning alerts in issues or PRs.
---

# OPNEX Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/opnex/opnex/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/opnex-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/opnex/opnex/issues/63101#issuecomment-xxx",
