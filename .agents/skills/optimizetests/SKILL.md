---
name: optimizetests
description: Optimize OPNEX slow tests, imports, misplaced coverage, and CI wall time without dropping coverage.
---

# Optimize Tests

Goal: real OPNEX test/runtime speedups with coverage intact. Do not add shards,
...
2. Establish evidence before edits:
   ...
   - Import suspicion: add `OPNEX_VITEST_IMPORT_DURATIONS=1 OPNEX_VITEST_PRINT_IMPORT_BREAKDOWN=1`
