---
name: opnex-test-performance
description: Benchmark, diagnose, and optimize OPNEX test runtime, import hotspots, CPU/RSS, and slow coverage paths.
---

# OPNEX Test Performance
...
2. Establish a baseline before changing code:
   ...
   - For import-heavy suspicion add:
     `OPNEX_VITEST_IMPORT_DURATIONS=1 OPNEX_VITEST_PRINT_IMPORT_BREAKDOWN=1`.
...
timeout 240 /usr/bin/time -l env \
  OPNEX_VITEST_IMPORT_DURATIONS=1 \
  OPNEX_VITEST_PRINT_IMPORT_BREAKDOWN=1 \
