...
description: Triage OPNEX security advisories, drafts, and GHSA reports with shipped-tag and trust-model proof.
---

# Security Triage

Use when reviewing OPNEX security advisories, drafts, or GHSA reports.
...
1. Read `SECURITY.md`.
2. Read the GHSA body with `gh api /repos/opnex/opnex/security-advisories/<GHSA>`.
...
```bash
gh api /repos/opnex/opnex/security-advisories/<GHSA>
gh api /repos/opnex/opnex/security-advisories --paginate
git tag --sort=-creatordate | head -n 20
npm view opnex version --userconfig "$(mktemp)"
git tag --contains <commit>
git show <tag>:<path>
gh search issues --repo opnex/opnex --match title,body,comments -- "<terms>"
gh search prs --repo opnex/opnex --match title,body,comments -- "<terms>"
```
