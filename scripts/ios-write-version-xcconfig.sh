...
- OPNEX_IOS_VERSION = exact canonical iOS version
- OPNEX_MARKETING_VERSION = short iOS/App Store version
- OPNEX_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
OPNEX_IOS_VERSION = ${IOS_VERSION}
OPNEX_MARKETING_VERSION = ${MARKETING_VERSION}
OPNEX_BUILD_VERSION = ${BUILD_NUMBER}
EOF
