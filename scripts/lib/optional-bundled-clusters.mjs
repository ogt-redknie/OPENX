...
export const OPTIONAL_BUNDLED_BUILD_ENV = "OPNEX_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.opnex?.install?.npmSpec === "string" &&
    packageJson.opnex.install.npmSpec.trim().length > 0
  );
}
