...
show_usage() {
    cat << EOF
clawlog - OPNEX Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OPNEX logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OPNEX logs flow through the macOS unified log (subsystem: ai.opnex).
