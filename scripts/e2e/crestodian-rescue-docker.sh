...
IMAGE_NAME="$(docker_e2e_resolve_image "opnex-crestodian-rescue-e2e" OPNEX_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="opnex-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t opnex-crestodian-rescue-log.XXXXXX)"
