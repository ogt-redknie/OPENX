...
IMAGE_NAME="$(docker_e2e_resolve_image "opnex-crestodian-planner-e2e" OPNEX_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="opnex-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t opnex-crestodian-planner-log.XXXXXX)"
