...
IMAGE_NAME="$(docker_e2e_resolve_image "opnex-session-runtime-context-e2e" OPNEX_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="opnex-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t opnex-session-runtime-context-log.XXXXXX)"
