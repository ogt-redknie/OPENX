...
# Output:
# - dist/OPNEX.app
# - dist/OPNEX-<version>.zip
# - dist/OPNEX-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.opnex.mac}"
...
ZIP="$ROOT_DIR/dist/OPNEX-$VERSION.zip"
DMG="$ROOT_DIR/dist/OPNEX-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OPNEX-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OPNEX-$VERSION.dSYM.zip"
