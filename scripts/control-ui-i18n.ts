...
const ENV_PROVIDER = "OPNEX_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "OPNEX_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "OPNEX_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "OPNEX_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "OPNEX_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "OPNEX_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "OPNEX_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "OPNEX_CONTROL_UI_I18N_PROMPT_TIMEOUT";
