...
const env = {
  ...process.env,
  OPNEX_LIVE_TEST: process.env.OPNEX_LIVE_TEST || "1",
  OPNEX_LIVE_TEST_QUIET: quietOverride ?? process.env.OPNEX_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.OPNEX_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
