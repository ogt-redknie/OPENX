...
- Keep product names in English: OPNEX, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the OPNEX Gateway, use “Gateway 网关”.
