...
const (
	...
	envDocsI18nProvider      = "OPNEX_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "OPNEX_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<opnex_docs_i18n_input>", "</opnex_docs_i18n_input>"} {
