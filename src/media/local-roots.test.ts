...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "opnex-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "opnex-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "opnex-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "opnex-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "opnex-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "opnex-legacy-state");
    const configDir = path.join("/tmp", "opnex-current-config");
