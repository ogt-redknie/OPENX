...
export const A2UI_PATH = "/__opnex__/a2ui";

export const CANVAS_HOST_PATH = "/__opnex__/canvas";

export const CANVAS_WS_PATH = "/__opnex__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.opnexCanvasA2UIAction.postMessage(...)
  // - Android: window.opnexCanvasA2UIAction.postMessage(...)
  const handlerNames = ["opnexCanvasA2UIAction"];
  ...
  globalThis.OPNEX = globalThis.OPNEX ?? {};
  globalThis.OPNEX.postMessage = postToNode;
  globalThis.OPNEX.sendUserAction = sendUserAction;
  globalThis.opnexPostMessage = postToNode;
  globalThis.opnexSendUserAction = sendUserAction;
