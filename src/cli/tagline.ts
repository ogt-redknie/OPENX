const DEFAULT_TAGLINE = "All your chats, one OPNEX.";
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a opnex roll: messy, delicious, effective.",
  ...
  "Built by opnexs, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'opnex gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.OPNEX_TAGLINE_INDEX;
