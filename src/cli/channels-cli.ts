    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["opnex channels list", "List configured channels and auth profiles."],
          ["opnex channels status --probe", "Run channel status checks and probes."],
          [
            "opnex channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["opnex channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.opnex.ai/cli/channels",
        )}\n`,
    );
