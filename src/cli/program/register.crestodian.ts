    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["opnex", "Start Crestodian."],
          ["opnex crestodian", "Start Crestodian explicitly."],
          ['opnex crestodian -m "status"', "Run one status request."],
          [
            'opnex crestodian -m "set default model openai/gpt-5.2" --yes',
