...
export function registerSetupCommand(program: Command) {
  program
    .command("setup")
    .description("Initialize the active OPNEX config and agent workspace")
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/setup", "docs.opnex.ai/cli/setup")}\n`,
    )
    .option(
      "--workspace <dir>",
      "Agent workspace directory (default: ~/.opnex/workspace; stored as agents.defaults.workspace)",
    )
