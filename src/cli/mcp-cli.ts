...
import { serveOPNEXChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage OPNEX MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose OPNEX channels over MCP stdio")
