...
export function hasAmbiguousGatewayAuthModeConfig(cfg: OPNEXConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: OPNEXConfig): void {
