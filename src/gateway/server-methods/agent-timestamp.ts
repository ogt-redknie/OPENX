 ...
 *
 * @see https://github.com/opnex/opnex/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an OPNEXConfig.
 */
export function timestampOptsFromConfig(cfg: OPNEXConfig): TimestampInjectionOptions {
  return {
