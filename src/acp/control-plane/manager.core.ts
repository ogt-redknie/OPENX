...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OPNEXConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OPNEXConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: OPNEXConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OPNEXConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: OPNEXConfig }): Promise<void> {
