...
export function listBindings(cfg: OPNEXConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: OPNEXConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OPNEXConfig) {
