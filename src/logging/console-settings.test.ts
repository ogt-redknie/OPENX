...
let originalOPNEXTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalOPNEXTestConsole = process.env.OPNEX_TEST_CONSOLE;
  process.env.OPNEX_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalOPNEXTestConsole === undefined) {
    delete process.env.OPNEX_TEST_CONSOLE;
  } else {
    process.env.OPNEX_TEST_CONSOLE = originalOPNEXTestConsole;
  }
