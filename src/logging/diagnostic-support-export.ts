...
const SUPPORT_EXPORT_PREFIX = "opnex-diagnostics-";
...
function readStabilityBundle(
  ...
  if (target === false) {
    return { status: "missing", dir: "$OPNEX_STATE_DIR/logs/stability" };
  }
...
function renderSummary(params: {
  ...
  return [
    ...
    "- `logs/opnex-sanitized.jsonl`: sanitized log summaries and metadata",
