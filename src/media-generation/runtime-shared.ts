...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: OPNEXConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: OPNEXConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: OPNEXConfig;
  agentDir?: string;
  listProviders: (cfg?: OPNEXConfig) => CapabilityProviderCandidate[];
}): string[] {
