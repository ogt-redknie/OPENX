...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OPNEXConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OPNEXConfig; env: NodeJS.ProcessEnv }): {
  cfg: OPNEXConfig;
  changes: string[];
} {
