...
function expectOPNEXSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = OPNEXSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectOPNEXSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = OPNEXSchema.safeParse(config);
