...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): OPNEXConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: OPNEXConfig, env: NodeJS.ProcessEnv) =>
