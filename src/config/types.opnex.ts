...
export type OPNEXConfig = {
  $schema?: string;
  meta?: {
    /** Last OPNEX version that wrote this config. */
  ...
  ui?: {
    /** Accent color for OPNEX UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const opnexConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = OPNEXConfig & {
  readonly [opnexConfigStateBrand]?: TState;
};
