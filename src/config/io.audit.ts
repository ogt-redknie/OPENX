...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.OPNEX_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.OPNEX_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.OPNEX_WATCH_COMMAND),
