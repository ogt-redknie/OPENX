...
type OPNEXReferencePaths = Awaited<ReturnType<typeof resolveOPNEXReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveOPNEXReferencePaths?: typeof resolveOPNEXReferencePaths;
};
...
function buildAgentSummaries(cfg: OPNEXConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): OPNEXReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveOPNEXReferencePaths ?? resolveOPNEXReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: OPNEX_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: OPNEX_SOURCE_URL,
    },
  };
}
