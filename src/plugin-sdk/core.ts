...
import type { OPNEXPluginApi } from "../plugins/types.js";
...
export type { OPNEXPluginToolContext, OPNEXPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: OPNEXConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
