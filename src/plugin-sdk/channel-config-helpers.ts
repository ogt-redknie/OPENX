...
type ChannelConfigAccessorParams<Config extends OPNEXConfig = OPNEXConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends OPNEXConfig = OPNEXConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends OPNEXConfig = OPNEXConfig>(
...
function setTopLevelChannelEnabledInConfigSection<Config extends OPNEXConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends OPNEXConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends OPNEXConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
