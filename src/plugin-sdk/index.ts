...
/** @deprecated Use OPNEXConfig instead */
export type { OPNEXConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use OPNEXConfig instead */
export type { OPNEXConfig as OPNEXSchemaType } from "../config/config.js";
export type {
