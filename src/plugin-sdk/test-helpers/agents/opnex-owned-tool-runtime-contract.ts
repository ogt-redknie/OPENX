...
export function installOPNEXOwnedToolHooks(params?: {
 ...
 * Pair with `installOPNEXOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetOPNEXOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
