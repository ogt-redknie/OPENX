...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("opnex.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("opnex.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: OPNEXConfig): Promise<ContextEngine> {
