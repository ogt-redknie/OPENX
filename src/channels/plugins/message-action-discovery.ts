...
export function listChannelMessageActions(cfg: OPNEXConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: OPNEXConfig): ChannelMessageCapability[] {
