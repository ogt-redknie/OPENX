...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: OPNEXConfig): string | undefined {
  ...
  function listAccountIds(cfg: OPNEXConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: OPNEXConfig): string {
