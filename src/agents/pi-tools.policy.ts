...
export function resolveSubagentToolPolicy(cfg?: OPNEXConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: OPNEXConfig["tools"]): string[] | undefined {
