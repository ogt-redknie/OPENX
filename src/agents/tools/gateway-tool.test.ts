...
const formatDoctorNonInteractiveHintMock = vi.fn(() => "Run: opnex doctor --non-interactive");
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: opnex doctor --non-interactive");
