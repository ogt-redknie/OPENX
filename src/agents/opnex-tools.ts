...
import { applyNodesToolWorkspaceGuard } from "./opnex-tools.nodes-workspace-guard.js";
import {
  collectPresentOPNEXTools,
  isUpdatePlanToolEnabledForOPNEXTools,
} from "./opnex-tools.registration.js";
...
const defaultOPNEXToolsDeps: OPNEXToolsDeps = {
  callGateway,
};

let opnexToolsDeps: OPNEXToolsDeps = defaultOPNEXToolsDeps;

export function createOPNEXTools(
  options?: {
  ...
  const resolvedConfig = options?.config ?? opnexToolsDeps.config;
  ...
  const tools: AnyAgentTool[] = [
    ...
    ...collectPresentOPNEXTools([imageGenerateTool, musicGenerateTool, videoGenerateTool]),
    ...(embedded
      ? []
      : [
          createGatewayTool({
    ...
    ...(embedded
      ...
      : [
          createSessionsSendTool({
            ...
            sandboxed: options?.sandboxed,
            config: resolvedConfig,
            callGateway: opnexToolsDeps.callGateway,
          }),
    ...
    ...collectPresentOPNEXTools([webSearchTool, webFetchTool, imageTool, pdfTool]),
  ];
  ...
  const wrappedPluginTools = resolveOPNEXPluginToolsForOptions({
    options,
    resolvedConfig,
...
export const __testing = {
  setDepsForTest(overrides?: Partial<OPNEXToolsDeps>) {
    opnexToolsDeps = overrides
      ? {
          ...defaultOPNEXToolsDeps,
          ...overrides,
        }
      : defaultOPNEXToolsDeps;
  },
