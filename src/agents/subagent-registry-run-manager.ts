...
const RECOVERABLE_WAIT_RETRY_DELAY_MS = process.env.OPNEX_TEST_FAST === "1" ? 25 : 5_000;
...
export function createSubagentRunManager(params: {
  ...
  resolveSubagentWaitTimeoutMs(cfg: OPNEXConfig, runTimeoutSeconds?: number): number;
