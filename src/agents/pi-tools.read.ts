...
function resolveAdaptiveReadMaxBytes(options?: OPNEXReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOPNEXReadTool(base, {
...
export function createOPNEXReadTool(
  base: AnyAgentTool,
  options?: OPNEXReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
