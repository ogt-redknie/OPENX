...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/opnex-sandbox",
    agentWorkspaceDir: "/tmp/opnex-workspace",
    workspaceAccess: "none",
    runtimeId: "opnex-sbx-test",
    runtimeLabel: "opnex-sbx-test",
    containerName: "opnex-sbx-test",
    ...
    browser: {
      ...
      containerName: "opnex-sbx-browser-test",
    },
