...
function resolveWatchPaths(workspaceDir: string, config?: OPNEXConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OPNEXConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OPNEXConfig }) {
