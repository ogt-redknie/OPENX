...
export function isConfigPathTruthy(config: OPNEXConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["opnex-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: OPNEXConfig): string[] | undefined {
