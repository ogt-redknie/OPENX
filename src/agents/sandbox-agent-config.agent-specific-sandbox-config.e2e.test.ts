...
async function resolveContext(config: OPNEXConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): OPNEXConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
