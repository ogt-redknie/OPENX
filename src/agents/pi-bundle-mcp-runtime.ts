...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("opnex.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: OPNEXConfig): number {
