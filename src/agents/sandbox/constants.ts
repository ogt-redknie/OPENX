...
export const DEFAULT_SANDBOX_IMAGE = "opnex-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "opnex-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "opnex-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "opnex-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "opnex-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "opnex-sandbox-browser";
