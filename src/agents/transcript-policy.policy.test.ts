...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.OPNEX_BUNDLED_PLUGINS_DIR;
  delete env.OPNEX_SKIP_PROVIDERS;
  delete env.OPNEX_SKIP_CHANNELS;
  delete env.OPNEX_SKIP_CRON;
  delete env.OPNEX_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
