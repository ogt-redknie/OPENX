...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set OPNEX_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `opnex dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control OPNEX.");
  } else if (hint) {
    runtime.log(hint);
  }
}
