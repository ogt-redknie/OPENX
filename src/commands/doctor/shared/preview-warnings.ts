...
function hasChannels(cfg: OPNEXConfig): boolean {
  return hasRecord(cfg.channels);
}

function hasPlugins(cfg: OPNEXConfig): boolean {
  return hasRecord(cfg.plugins);
}

function hasPluginLoadPaths(cfg: OPNEXConfig): boolean {
...
function hasExplicitChannelPluginBlockerConfig(cfg: OPNEXConfig): boolean {
...
function hasConfiguredSafeBins(cfg: OPNEXConfig): boolean {
