...
export function scanLegacyToolsBySenderKeys(cfg: OPNEXConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: OPNEXConfig): {
  config: OPNEXConfig;
  changes: string[];
} {
