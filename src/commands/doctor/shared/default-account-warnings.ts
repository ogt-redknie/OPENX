...
export function collectMissingDefaultAccountBindingWarnings(cfg: OPNEXConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: OPNEXConfig): string[] {
  const warnings: string[] = [];
