...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.opnex.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("opnex hooks list")}`,
      `  ${formatCliCommand("opnex hooks enable <name>")}`,
      `  ${formatCliCommand("opnex hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
