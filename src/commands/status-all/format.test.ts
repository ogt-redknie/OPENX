...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://opnex.local")).toBe("https://opnex.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://opnex.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: opnex security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://opnex.local" },
