...
export function listAuthProfileStorePaths(config: OPNEXConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: OPNEXConfig, stateDir: string): string[] {
