...
function resolveResolutionLimits(config: OPNEXConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OPNEXConfig): SecretProviderConfig {
