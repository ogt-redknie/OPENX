...
function makeContext(sourceConfig: OPNEXConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: OPNEXConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: OPNEXConfig): void {
