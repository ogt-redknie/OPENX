...
function resolveRealtimeVoiceProviderEntries(cfg?: OPNEXConfig): RealtimeVoiceProviderPlugin[] {
...
function buildProviderMaps(cfg?: OPNEXConfig): {
...
export function listRealtimeVoiceProviders(cfg?: OPNEXConfig): RealtimeVoiceProviderPlugin[] {
