/**
 * Hook system for OPNEX agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("opnex.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("opnex.internalHooksEnabled");
