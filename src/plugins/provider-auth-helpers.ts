...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveOPNEXAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: OPNEXConfig): SecretRef {
