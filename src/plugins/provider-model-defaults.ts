...
export function applyGoogleGeminiModelDefault(cfg: OPNEXConfig): {
  next: OPNEXConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: OPNEXConfig): OPNEXConfig {
...
export function applyOpenAIConfig(cfg: OPNEXConfig): OPNEXConfig {
...
export function applyOpencodeGoModelDefault(cfg: OPNEXConfig): {
  next: OPNEXConfig;
  changed: boolean;
} {
