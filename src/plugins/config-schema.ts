...
import type { OPNEXPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: OPNEXPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): OPNEXPluginConfigSchema {
  return {
