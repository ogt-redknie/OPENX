...
function readConfiguredProviderApiId(providerId: string, cfg?: OPNEXConfig): string | undefined {
...
function resolveMemoryEmbeddingProviderLookupIds(id: string, cfg?: OPNEXConfig): string[] {
  const ids = [id];
