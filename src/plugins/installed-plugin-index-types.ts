...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by OPNEX from plugin manifests, install records, and config policy. Use `opnex plugins registry --refresh`, `opnex plugins install/update/uninstall`, or `opnex plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored opnex.install metadata. This describes catalog/package
