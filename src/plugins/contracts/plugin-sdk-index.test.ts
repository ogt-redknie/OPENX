...
import type { ClawdbotConfig, OPNEXConfig, OPNEXSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ClawdbotConfig>().toEqualTypeOf<OPNEXConfig>();
    expectTypeOf<OPNEXSchemaType>().toEqualTypeOf<OPNEXConfig>();
  });
