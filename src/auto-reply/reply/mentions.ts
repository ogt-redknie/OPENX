...
function resolveMentionPatterns(cfg: OPNEXConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OPNEXConfig | undefined, agentId?: string): RegExp[] {
