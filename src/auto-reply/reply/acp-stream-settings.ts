...
function resolveAcpStreamCoalesceIdleMs(cfg: OPNEXConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OPNEXConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OPNEXConfig): AcpProjectionSettings {
