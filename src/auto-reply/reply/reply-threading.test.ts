...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as OPNEXConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as OPNEXConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
