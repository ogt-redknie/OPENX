...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@opnex", { botUsername: "opnex" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@opnex args", {
        botUsername: "opnex",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "opnex" })).toBe(
      "/help@otherbot",
    );
  });
