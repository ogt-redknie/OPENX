...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.opnex/opnex.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde opnex dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con opnex models auth",
