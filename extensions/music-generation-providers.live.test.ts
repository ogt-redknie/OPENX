...
const providerFilter = parseCsvFilter(process.env.OPNEX_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.OPNEX_LIVE_MUSIC_GENERATION_MODELS);
