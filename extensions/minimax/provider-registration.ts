...
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "opnex/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "opnex/plugin-sdk/provider-usage";
...
export function registerMinimaxProviders(api: OPNEXPluginApi) {
