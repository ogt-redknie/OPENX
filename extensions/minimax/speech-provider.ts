...
import { asFiniteNumber, asObject, trimToUndefined } from "opnex/plugin-sdk/speech-core";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: OPNEXConfig | undefined): string | undefined {
