...
const installedSymbol = Symbol.for("opnex.opnex.ajv-compile-cache.installed");
const cacheSymbol = Symbol.for("opnex.opnex.ajv-compile-cache.entries");
...
export function installOPNEXAjvCompileCache() {
