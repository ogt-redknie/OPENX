...
function listConfiguredAccountIds(cfg: OPNEXConfig): string[] {
...
function listBoundAccountIds(cfg: OPNEXConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function resolveDefaultAgentBoundAccountId(cfg: OPNEXConfig, channelId: string): string | null {
...
export function resolveDefaultTelegramAccountSelection(cfg: OPNEXConfig): {
  accountId: string;
  accountIds: string[];
