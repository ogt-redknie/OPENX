...
import { createChannelPluginBase, type ChannelPlugin } from "opnex/plugin-sdk/channel-core";
 ...
 */
function isBlockedByMultiBotGuard(cfg: OPNEXConfig, accountId: string): boolean {
