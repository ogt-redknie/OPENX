...
export function shouldShowTelegramDmAccessWarning(cfg: OPNEXConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`opnex config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`opnex config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
