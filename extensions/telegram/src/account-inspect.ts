import { resolveAccountWithDefaultFallback } from "opnex/plugin-sdk/account-core";
...
import { coerceSecretRef } from "opnex/plugin-sdk/secret-input-runtime";
...
function inspectTokenValue(params: { cfg: OPNEXConfig; value: unknown }): {
  token: string;
