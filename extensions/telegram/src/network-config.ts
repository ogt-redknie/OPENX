...
import { isTruthyEnvValue, isWSL2Sync } from "opnex/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "opnex/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "OPNEX_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "OPNEX_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "OPNEX_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable OPNEX_TELEGRAM_DNS_RESULT_ORDER
