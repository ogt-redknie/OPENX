...
export function listMattermostAccountIds(cfg: OPNEXConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: OPNEXConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OPNEXConfig): ResolvedMattermostAccount[] {
