...
vi.mock("opnex/plugin-sdk/outbound-media", () => ({
...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under OPNEX control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredOPNEXTmpDir(), "opnex-zalo-outbound-media");
