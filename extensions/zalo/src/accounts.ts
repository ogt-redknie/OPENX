...
function mergeZaloAccountConfig(cfg: OPNEXConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OPNEXConfig): ResolvedZaloAccount[] {
