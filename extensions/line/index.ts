...
type RegisteredLineCardCommand = Parameters<OPNEXPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: OPNEXPluginApi): Promise<RegisteredLineCardCommand> {
