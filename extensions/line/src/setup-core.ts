import type { ChannelSetupAdapter, OPNEXConfig } from "opnex/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "opnex/plugin-sdk/setup";
...
export function isLineConfigured(cfg: OPNEXConfig, accountId: string): boolean {
