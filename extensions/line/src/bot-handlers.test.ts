...
vi.mock("opnex/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("opnex/plugin-sdk/channel-pairing", () => ({
...
vi.mock("opnex/plugin-sdk/command-auth", () => ({
...
vi.mock("opnex/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("opnex/plugin-sdk/group-access", () => ({
...
vi.mock("opnex/plugin-sdk/routing", () => ({
