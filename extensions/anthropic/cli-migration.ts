...
type AgentDefaultsModel = NonNullable<NonNullable<OPNEXConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<OPNEXConfig["agents"]>["defaults"]>["models"];
type AgentDefaultsRuntimePolicy = NonNullable<
  NonNullable<OPNEXConfig["agents"]>["defaults"]
>["agentRuntime"];
