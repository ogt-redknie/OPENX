...
} from "opnex/plugin-sdk/cli-backend";
...
// steer OPNEX-managed Claude CLI runs toward a different provider,
...
function isOPNEXRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isOPNEXRequestedYolo(context)
