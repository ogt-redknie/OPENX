...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: OPNEXConfig, accountId?: string) => {
  ...
  getCurrent: (cfg: OPNEXConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: OPNEXConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure OPNEX has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: OPNEXConfig; accountId?: string }) =>
