...
import { normalizeScpRemoteHost } from "opnex/plugin-sdk/host-runtime";
import { isInboundPathAllowed, kindFromMime } from "opnex/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "opnex/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "opnex/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "opnex/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "opnex/plugin-sdk/reply-runtime";
import { getRuntimeConfig } from "opnex/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose, shouldLogVerbose, warn } from "opnex/plugin-sdk/runtime-env";
import {
...
import { truncateUtf16Safe } from "opnex/plugin-sdk/text-runtime";
import { waitForTransportReady } from "opnex/plugin-sdk/transport-ready-runtime";
 ...
 *   exec ssh -T opnex@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., opnex@192.168.64.3)
