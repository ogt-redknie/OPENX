...
function mergeIMessageAccountConfig(cfg: OPNEXConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OPNEXConfig): ResolvedIMessageAccount[] {
