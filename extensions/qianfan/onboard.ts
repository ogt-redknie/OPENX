...
function resolveQianfanPreset(cfg: OPNEXConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: OPNEXConfig): OPNEXConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: OPNEXConfig): OPNEXConfig {
