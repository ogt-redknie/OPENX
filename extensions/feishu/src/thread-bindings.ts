...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "opnex/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("opnex.feishuThreadBindingsState");
