...
import { normalizeSecretInputString, type SecretInput } from "opnex/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: OPNEXConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: OPNEXConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: OPNEXConfig): string {
