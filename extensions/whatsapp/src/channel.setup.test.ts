import { createQueuedWizardPrompter } from "opnex/plugin-sdk/plugin-test-runtime";
  ...
  return {
    ...
    splitSetupEntries: (raw: string) =>
      raw
        ...
        .filter(Boolean),
    setSetupChannelEnabled: (cfg: OPNEXConfig, channel: string, enabled: boolean) => ({
      ...cfg,
      channels: {
        ...cfg.channels,
        [channel]: {
          ...(cfg.channels?.[channel as keyof NonNullable<OPNEXConfig["channels"]>] as object),
          enabled,
        },
      },
    }),
