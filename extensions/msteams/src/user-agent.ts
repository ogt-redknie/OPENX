...
function resolveOPNEXVersion(): string {
  try {
 ...
 * and appends the OPNEX version.
 *
 * Format: "teams.ts[apps]/<sdk-version> OPNEX/<opnex-version>"
 * Example: "teams.ts[apps]/2.0.5 OPNEX/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} OPNEX/${resolveOPNEXVersion()}`;
  return cachedUserAgent;
}
