...
function resolveConfiguredOllamaWebSearchApiKey(config?: OPNEXConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: OPNEXConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: OPNEXConfig): string {
