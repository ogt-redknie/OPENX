...
vi.mock("opnex/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("opnex/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
