...
export function resolveTavilySearchConfig(cfg?: OPNEXConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: OPNEXConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: OPNEXConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
