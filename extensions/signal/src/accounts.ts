...
function mergeSignalAccountConfig(cfg: OPNEXConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OPNEXConfig): ResolvedSignalAccount[] {
