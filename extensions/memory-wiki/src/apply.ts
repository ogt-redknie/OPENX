...
const GENERATED_START = "<!-- opnex:wiki:generated:start -->";
const GENERATED_END = "<!-- opnex:wiki:generated:end -->";
const HUMAN_START = "<!-- opnex:human:start -->";
const HUMAN_END = "<!-- opnex:human:end -->";
