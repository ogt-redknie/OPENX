...
import { mapPluginConfigIssues } from "opnex/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type OPNEXPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: OPNEXPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".opnex", "wiki", "main");
}
