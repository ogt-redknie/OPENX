...
import { hasConfiguredSecretInput } from "opnex/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: OPNEXConfig): Record<string, unknown> | null {
