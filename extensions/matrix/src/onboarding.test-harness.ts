import type { OutputRuntimeEnv } from "opnex/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "opnex/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "OPNEX Gateway",
    },
    confirm: {
