import { resolveConfiguredAcpBindingRecord } from "opnex/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "opnex/plugin-sdk/session-binding-runtime";
