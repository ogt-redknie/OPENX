...
import { collectIssuesForEnabledAccounts } from "opnex/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: opnex channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
