...
This package contains the **BlueBubbles external channel plugin** for OPNEX.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `opnex/plugin-sdk` helpers.
