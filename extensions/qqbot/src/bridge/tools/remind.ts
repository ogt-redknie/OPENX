import { callGatewayTool } from "opnex/plugin-sdk/agent-harness-runtime";
import type {
  AnyAgentTool,
  OPNEXPluginApi,
...
export function createRemindTool(
  toolContext: OPNEXPluginToolContext = {},
...
export function registerRemindTool(api: OPNEXPluginApi): void {
