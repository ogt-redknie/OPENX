...
import { createAsyncLock } from "opnex/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "opnex/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- opnex:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- opnex:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "opnex:dreaming:backfill-entry";
