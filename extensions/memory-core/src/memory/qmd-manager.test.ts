...
const MEMORY_EMBEDDING_PROVIDERS_KEY = Symbol.for("opnex.memoryEmbeddingProviders");
...
vi.mock("opnex/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("opnex/plugin-sdk/memory-core-host-engine-foundation")
  >("opnex/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
vi.mock("opnex/plugin-sdk/file-lock", async () => {
  const actual = await vi.importActual<typeof import("opnex/plugin-sdk/file-lock")>(
    "opnex/plugin-sdk/file-lock",
  );
  return {
    ...actual,
