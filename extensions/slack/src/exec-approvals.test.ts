...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<OPNEXConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<OPNEXConfig["channels"]>["slack"]>>,
): OPNEXConfig {
  return {
    channels: {
      slack: {
