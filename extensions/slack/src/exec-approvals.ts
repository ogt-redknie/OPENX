...
import { doesApprovalRequestMatchChannelAccount } from "opnex/plugin-sdk/approval-native-runtime";
import type { OPNEXConfig } from "opnex/plugin-sdk/config-types";
import { normalizeStringifiedOptionalString } from "opnex/plugin-sdk/text-runtime";
...
function resolveSlackOwnerApprovers(cfg: OPNEXConfig): string[] {
