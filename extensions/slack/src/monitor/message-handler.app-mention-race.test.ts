...
vi.mock("opnex/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("opnex/plugin-sdk/channel-inbound")>(
    "opnex/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
