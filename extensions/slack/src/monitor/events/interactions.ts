...
// Prefix for OPNEX-generated action IDs to scope our handler
const OPNEX_ACTION_PREFIX = "opnex:";
...
export function registerSlackInteractionEvents(params: {
  ...
  const modalMatcher = new RegExp(`^${OPNEX_ACTION_PREFIX}`);

  // Handle OPNEX modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
