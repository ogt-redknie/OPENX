...
function enableSlackAccount(cfg: OPNEXConfig, accountId: string): OPNEXConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: OPNEXConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: OPNEXConfig; accountId: string }) =>
