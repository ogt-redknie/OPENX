...
Official Voice Call plugin for **OPNEX**.
...
Docs: `https://docs.opnex.ai/plugins/voice-call`
Plugin system: `https://docs.opnex.ai/plugin`

## Install (local dev)

### Option A: install via OPNEX (recommended)
...
- If older configs still use `provider: "log"`, `twilio.from`, or legacy `streaming.*` OpenAI keys, run `opnex doctor --fix` to rewrite them.
- advanced webhook, streaming, and tunnel notes: `https://docs.opnex.ai/plugins/voice-call`
...
`https://docs.opnex.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.opnex.ai/plugins/voice-call#tts-for-calls`
