...
export function resolveSearxngCategories(config?: OPNEXConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: OPNEXConfig): string | undefined {
