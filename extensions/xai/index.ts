...
import { OPENAI_COMPATIBLE_REPLAY_HOOKS } from "opnex/plugin-sdk/provider-model-shared";
import { defaultToolStreamExtraParams } from "opnex/plugin-sdk/provider-stream-shared";
import { jsonResult, readProviderEnvValue } from "opnex/plugin-sdk/provider-web-search";
    ...
    execute: async (toolCallId: string, args: Record<string, unknown>) => {
      ...
      if (!tool) {
        return jsonResult({
          ...
          docs: "https://docs.opnex.ai/tools/code-execution",
        });
      }
