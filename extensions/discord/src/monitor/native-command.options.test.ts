...
let listNativeCommandSpecs: typeof import("opnex/plugin-sdk/command-auth").listNativeCommandSpecs;
...
function createNativeCommand(
  ...
  opts?: {
    cfg?: OPNEXConfig;
    discordConfig?: NonNullable<OPNEXConfig["channels"]>["discord"];
  },
  ...
  const baseCfg: OPNEXConfig = opts?.cfg ?? {};
  const discordConfig: NonNullable<OPNEXConfig["channels"]>["discord"] =
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("opnex/plugin-sdk/command-auth"));
  ...
  it("returns no autocomplete choices for group DMs outside dm.groupChannels", async () => {
    ...
    } satisfies NonNullable<OPNEXConfig["channels"]>["discord"];
    const command = createNativeCommand("think", {
      cfg: {
        commands: {
          allowFrom: {
  ...
  it("truncates Discord command and option descriptions to Discord's limit", () => {
    ...
    const discordConfig = {} as NonNullable<OPNEXConfig["channels"]>["discord"];
