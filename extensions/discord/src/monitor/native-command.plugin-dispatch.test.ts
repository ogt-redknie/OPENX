...
import { resolveDirectStatusReplyForSession } from "opnex/plugin-sdk/command-status-runtime";
...
import { dispatchReplyWithDispatcher } from "opnex/plugin-sdk/reply-dispatch-runtime";
...
async function createNativeCommand(cfg: OPNEXConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: OPNEXConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("opnex/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("opnex/plugin-sdk/plugin-runtime").executePluginCommand,
    );
