...
import type { SessionBindingRecord } from "opnex/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "opnex/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "opnex/plugin-sdk/routing";
...
export type LoadedConfig = OPNEXConfig;
export type RuntimeEnv = import("opnex/plugin-sdk/runtime-env").RuntimeEnv;
