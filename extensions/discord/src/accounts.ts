...
import type { DiscordAccountConfig, DiscordActionConfig, OPNEXConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: OPNEXConfig): ResolvedDiscordAccount[] {
