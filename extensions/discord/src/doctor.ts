...
import { collectProviderDangerousNameMatchingScopes } from "opnex/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: OPNEXConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: OPNEXConfig,
  doctorFixCommand: string,
): { config: OPNEXConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: OPNEXConfig): string[] {
