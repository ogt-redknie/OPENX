...
import { safeParseJsonWithSchema, safeParseWithSchema } from "opnex/plugin-sdk/extension-shared";
import { isSecretRef } from "opnex/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: OPNEXConfig): ResolvedGoogleChatAccount[] {
