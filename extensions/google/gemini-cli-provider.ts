...
import { buildOauthProviderAuthResult } from "opnex/plugin-sdk/provider-auth-result";
...
import { fetchGeminiUsage } from "opnex/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: OPNEXPluginApi) {
