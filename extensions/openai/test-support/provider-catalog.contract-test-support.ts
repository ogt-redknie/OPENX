...
import type { ProviderPlugin } from "opnex/plugin-sdk/provider-test-contracts";
...
vi.mock("opnex/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("opnex/plugin-sdk/provider-catalog-runtime")
  >("opnex/plugin-sdk/provider-catalog-runtime");
