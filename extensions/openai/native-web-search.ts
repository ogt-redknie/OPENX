...
import { streamWithPayloadPatch } from "opnex/plugin-sdk/provider-stream-shared";
...
function shouldUseOpenAINativeWebSearchProvider(config: OPNEXConfig | undefined): boolean {
