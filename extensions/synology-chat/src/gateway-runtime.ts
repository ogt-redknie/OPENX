import { DEFAULT_ACCOUNT_ID, type OPNEXConfig } from "opnex/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "opnex/plugin-sdk/webhook-ingress";
