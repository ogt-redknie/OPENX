...
vi.mock("opnex/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("opnex/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("opnex/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("opnex/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("opnex/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("opnex/plugin-sdk/webhook-ingress");
  return {
    ...actual,
