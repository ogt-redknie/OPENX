...
import { resolveDangerousNameMatchingEnabled } from "opnex/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full OPNEX config object. */
function getChannelConfig(cfg: OPNEXConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: OPNEXConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.OPNEX_BOT_NAME ?? "OPNEX";
