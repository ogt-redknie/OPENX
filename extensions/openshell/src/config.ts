...
import { buildPluginConfigSchema, type OPNEXPluginConfigSchema } from "opnex/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): OPNEXPluginConfigSchema {
